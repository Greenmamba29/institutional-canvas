  ...
  public: {
    Tables: {
      ...
      battery_inventory: {
        ...
        Relationships: [
          {
            foreignKeyName: "battery_inventory_location_id_fkey"
            columns: ["location_id"]
            isOneToOne: false
      ...
      chain_of_custody: {
        ...
        Relationships: [
          {
            foreignKeyName: "chain_of_custody_inventory_id_fkey"
      ...
      downgrade_notifications: {
        Row: {
          ...
          notified_at: string
          org_id: string
          retention_extended_to: string | null
        }
        Insert: {
          acknowledged_at?: string | null
          deletion_scheduled_at: string
        ...
        Relationships: [
          {
            foreignKeyName: "downgrade_notifications_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      evidence_documents: {
        ...
        Relationships: [
          {
            foreignKeyName: "evidence_documents_grant_id_fkey"
            columns: ["grant_id"]
            isOneToOne: false
      ...
      funding_pipeline: {
        ...
        Relationships: [
          {
            foreignKeyName: "funding_pipeline_grant_id_fkey"
            columns: ["grant_id"]
            isOneToOne: false
            referencedRelation: "grants"
            referencedColumns: ["id"]
      ...
      introductions: {
        ...
        Relationships: [
          {
            foreignKeyName: "introductions_buyer_org_id_fkey"
          ...
          {
            foreignKeyName: "introductions_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "introductions_seller_org_id_fkey"
          ...
          {
            foreignKeyName: "introductions_telebuy_session_id_fkey"
            columns: ["telebuy_session_id"]
            isOneToOne: false
      ...
      partner_matching: {
        ...
        Relationships: [
          {
            foreignKeyName: "partner_matching_grant_id_fkey"
            columns: ["grant_id"]
            isOneToOne: false
            referencedRelation: "grants"
            referencedColumns: ["id"]
      ...
      processing_orders: {
        ...
        Relationships: [
          {
            foreignKeyName: "processing_orders_inventory_id_fkey"
            columns: ["inventory_id"]
            isOneToOne: false
            referencedRelation: "battery_inventory"
            referencedColumns: ["id"]
      ...
      purchases: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "purchases_grant_id_fkey"
            columns: ["grant_id"]
            isOneToOne: false
            referencedRelation: "grants"
            referencedColumns: ["id"]
      ...
      rfqs: {
        ...
        Relationships: [
          {
            foreignKeyName: "rfqs_grant_id_fkey"
            columns: ["grant_id"]
            isOneToOne: false
            referencedRelation: "grants"
            referencedColumns: ["id"]
      ...
      subscription_lifecycle_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "subscription_lifecycle_events_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_subscription_tier: { Args: never; Returns: string }
      get_telebuy_session: {
      ...
      grace_period_days_remaining: { Args: never; Returns: number }
      ...
      open_scheduled_auctions: { Args: never; Returns: undefined }
      org_trial_status: {
        Args: never
        Returns: {
      ...
      refresh_market_kpis: { Args: never; Returns: Json }
      remove_org_member: {
        Args: { p_org_id: string; p_user_id: string }
        Returns: boolean
      }
